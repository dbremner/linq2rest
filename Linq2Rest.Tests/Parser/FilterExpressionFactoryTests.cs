...
namespace Linq2Rest.Tests.Parser
{
	...
	public class FilterExpressionFactoryTests
	{
		...
		[TestCase("(startswith(tolower(StringValue),'foo') eq true and endswith(tolower(StringValue),'1') eq true) and (tolower(StringValue) eq 'bar03')", "x => (((x.StringValue.ToLowerInvariant().StartsWith(\"foo\") == True) AndAlso (x.StringValue.ToLowerInvariant().EndsWith(\"1\") == True)) AndAlso (x.StringValue.ToLowerInvariant() == \"bar03\"))")]
		[TestCase("(startswith(tolower(StringValue),'foo') and endswith(tolower(StringValue),'1')) and (tolower(StringValue) eq 'bar03')", "x => ((x.StringValue.ToLowerInvariant().StartsWith(\"foo\") AndAlso x.StringValue.ToLowerInvariant().EndsWith(\"1\")) AndAlso (x.StringValue.ToLowerInvariant() == \"bar03\"))")]
		...
		[TestCase("substringof('endIsSpaceX ', StringValue) or substringof('endIsSpaceY ', StringValue)", "x => (x.StringValue.Contains(\"endIsSpaceX \") OrElse x.StringValue.Contains(\"endIsSpaceY \"))")]
		[TestCase("(substringof('endIsSpaceX ', StringValue) or substringof('endIsSpaceY ', StringValue)) or StringValue eq 'other'", "x => ((x.StringValue.Contains(\"endIsSpaceX \") OrElse x.StringValue.Contains(\"endIsSpaceY \")) OrElse (x.StringValue == \"other\"))")]
		...
		[TestCase("Children/any(a: startswith(tolower(a/ChildStringValue), 'foo'))", "x => x.Children.Any(a => a.ChildStringValue.ToLowerInvariant().StartsWith(\"foo\"))")]
		[TestCase("Children/all(a: startswith(tolower(a/ChildStringValue), 'foo'))", "x => x.Children.All(a => a.ChildStringValue.ToLowerInvariant().StartsWith(\"foo\"))")]
		[TestCase("Children/all(a: startswith(tolower(a/ChildStringValue), 'foo') and endswith(tolower(a/ChildStringValue), 'foo'))", "x => x.Children.All(a => (a.ChildStringValue.ToLowerInvariant().StartsWith(\"foo\") AndAlso a.ChildStringValue.ToLowerInvariant().EndsWith(\"foo\")))")]
		[TestCase("Children/any(a: a/Children/any(b: startswith(tolower(b/GrandChildStringValue), 'foo')))", "x => x.Children.Any(a => a.Children.Any(b => b.GrandChildStringValue.ToLowerInvariant().StartsWith(\"foo\")))")]
		[TestCase("Children/any(a: startswith(tolower(a/ChildStringValue), StringValue))", "x => x.Children.Any(a => a.ChildStringValue.ToLowerInvariant().StartsWith(x.StringValue))")]
