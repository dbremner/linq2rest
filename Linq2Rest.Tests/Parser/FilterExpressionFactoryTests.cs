...
namespace Linq2Rest.Tests.Parser
{
	...
	public class FilterExpressionFactoryTests
	{
		...
		[TestCase("startswith(StringValue, 'text1,text2') eq true", "x => (x.StringValue.StartsWith(\"text1,text2\", OrdinalIgnoreCase) == True)")]
		[TestCase("startswith(StringValue, ',text1,,, text2,') eq true", "x => (x.StringValue.StartsWith(\",text1,,, text2,\", OrdinalIgnoreCase) == True)")]
		[TestCase("startswith(StringValue, ',text1's,,, text2,') eq true", "x => (x.StringValue.StartsWith(\",text1's,,, text2,\", OrdinalIgnoreCase) == True)")]
		...
		[TestCase("startswith(tolower(StringValue),'foo,bar')", "x => x.StringValue.ToLowerInvariant().StartsWith(\"foo,bar\", OrdinalIgnoreCase)")]
