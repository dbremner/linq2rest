...
namespace Linq2Rest.Tests.Provider
{
	...
	public class RestPutQueryProviderTests
	{
		...
		public void FixtureSetup()
		{
			...
			_provider = new RestPutQueryProvider<FakeItem>(_mockClient.Object, new TestSerializerFactory(), new ExpressionProcessor(new ExpressionWriter(memberNameResolver), memberNameResolver), _inputData);
		}
