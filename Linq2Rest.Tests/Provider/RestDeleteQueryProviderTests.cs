...
namespace Linq2Rest.Tests.Provider
{
	...
	public class RestDeleteQueryProviderTests
	{
		...
		public void FixtureSetup()
		{
			...
			_provider = new RestDeleteQueryProvider<FakeItem>(_mockClient.Object, new TestSerializerFactory(mockResolver.Object), new ExpressionProcessor(new ExpressionWriter(memberNameResolver), memberNameResolver), typeof(FakeItem));
		}
