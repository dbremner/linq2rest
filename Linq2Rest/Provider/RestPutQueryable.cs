...
namespace Linq2Rest.Provider
{
	...
	internal class RestPutQueryable<T> : RestQueryableBase<T>
	{
		...
		public RestPutQueryable(IRestClient client, ISerializerFactory serializerFactory, IMemberNameResolver memberNameResolver, Expression expression, Stream inputData, Type sourceType)
